        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mb-2">
            ...
            <input
              ...
              className="w-full text-sm text-gray-700 border border-gray-300 rounded-md cursor-pointer bg-gray-200 file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:text-sm file:font-semibold file:bg-blue-500  file:text-white hover:file:bg-blue-600"
            />
          </div>
